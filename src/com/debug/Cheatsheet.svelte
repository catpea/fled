...
<header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
  <div class="container-fluid d-flex align-items-center">
    <h1 class="d-flex align-items-center fs-4 text-white mb-0">
      <img src="/docs/5.2/assets/brand/bootstrap-logo-white.svg" class="me-3" alt="Bootstrap" width="38" height="30">
      Cheatsheet
    </h1>
    ...
    <article class="my-3" id="navbar">
      ...
      <div>
        ...
        <nav class="navbar navbar-expand-lg bg-light">
          <div class="container-fluid">
            <a class="navbar-brand" href="#">
              <img src="/docs/5.2/assets/brand/bootstrap-logo-white.svg" class="d-inline-block align-top" alt="Bootstrap" loading="lazy" style="filter: invert(1) grayscale(100%) brightness(200%);" width="38" height="30">
            </a>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary mt-5">
          <div class="container-fluid">
            <a class="navbar-brand" href="#">
              <img src="/docs/5.2/assets/brand/bootstrap-logo-white.svg" class="d-inline-block align-top" alt="Bootstrap" loading="lazy" width="38" height="30">
            </a>
